...
class ReportSummaryInboundController extends Controller
{
    private $menu_id = 33;
    ...
    {
        $data = [];
        return view("report-summary-inbound.index",compact("data"));
    }
    ...
    public function printPDF(Request $request)
    {
        ...
        // dd($data);
        $pdf = Pdf::loadView('report-summary-inbound.pdf', compact('data'))->setPaper('a4', 'potrait');;
