...
CREATE DATABASE IF NOT EXISTS `wms` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `wms`;
...
CREATE TABLE IF NOT EXISTS `m_item_classification` (
  ...
  `process_id` int(3) NOT NULL DEFAULT '0',
  `created_by` varchar(20) DEFAULT NULL,
  `created_on` datetime DEFAULT NULL,
  `is_active` enum('Y','N') DEFAULT NULL,
  `is_deleted` enum('Y','N') DEFAULT NULL,
  PRIMARY KEY (`item_classification_id`,`process_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='item classification on warehouse';
...
CREATE TABLE IF NOT EXISTS `m_item_classification_copy` (
  ...
  `is_deleted` enum('Y','N') DEFAULT NULL,
  PRIMARY KEY (`item_classification_id`,`process_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='item classification on warehouse';
...
CREATE TABLE IF NOT EXISTS `m_item_uom` (
  ...
  `uom_type_id` int(10) NOT NULL DEFAULT '0',
  `created_by` varchar(20) DEFAULT NULL,
  `created_on` datetime DEFAULT NULL,
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='master item uom warehouse';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='master item uom warehouse';
...
-- Dumping data for table wms.m_menu: 40 rows
/*!40000 ALTER TABLE `m_menu` DISABLE KEYS */;
INSERT INTO `m_menu` (`menu_id`, `menu_name`, `description`, `platform_id`, `parent_id`, `status`, `no_urut`, `id_dom`, `menu_link`, `menu_icon`, `is_active`, `user_created`, `datetime_created`) VALUES
	(31, 'User Management', 'User Management', '2', 10, 1, 1, 'user_management', 'user_management', NULL, 'Y', 'backdoor', '2023-03-16 09:42:13'),
	(30, 'Item', 'Item', '2', 9, 1, 10, 'master_item', 'master_item', NULL, 'Y', 'backdoor', '2023-03-14 10:01:07'),
	(29, 'Supplier', 'Supplier', '2', 9, 1, 9, 'master_supplier', 'master_supplier', NULL, 'Y', 'backdoor', '2023-03-14 10:00:31'),
	(25, 'Location Index', 'Location Index', '2', 9, 1, 5, 'master_location_index', 'master_location_index', NULL, 'Y', 'backdoor', '2023-03-14 09:57:58'),
	(24, 'Location', 'Location', '2', 9, 1, 4, 'master_location', 'master_location', NULL, 'Y', 'backdoor', '2023-03-14 09:55:45'),
	(22, 'Project', 'Project', '2', 9, 1, 2, 'master_project', 'master_project', NULL, 'Y', 'backdoor', '2023-03-07 11:24:59'),
	(19, 'Packing', 'Packing', '2', 6, 1, 4, 'packing', 'packing', NULL, 'Y', 'rdarmawan', '2023-01-06 13:56:53'),
	(20, 'Movement Location', 'Movement Location', '2', 5, 1, 2, 'movement_location', 'movement_location', NULL, 'Y', 'backdoor', '2023-01-06 13:56:53'),
	(21, 'Stock Count', 'Stock Count', '2', 5, 1, 5, 'stock_count', 'stock_count', NULL, 'Y', 'backdoor', '2023-01-13 12:56:46'),
	(23, 'Warehouse', 'Warehouse', '2', 9, 1, 3, 'master_warehouse', 'master_warehouse', NULL, 'Y', 'backdoor', '2023-03-08 08:07:55'),
	(18, 'Inventory Adjustment', 'Inventory Adjustment', '2', 5, 1, 4, 'inventory_adjustment', 'inventory_adjustment', NULL, 'Y', 'backdoor', '2023-01-04 10:38:04'),
	(17, 'Checking', 'Checking', '2', 6, 1, 3, 'checking', 'checking', NULL, 'Y', 'backdoor', '2023-01-04 10:02:43'),
	(16, 'Stock Transfer', 'Stock Transfer', '2', 5, 1, 3, 'stock_transfer', 'stock_transfer', NULL, 'Y', 'backdoor', '2022-12-27 09:44:12'),
	(15, 'Inventory List', 'Inventory List', '2', 5, 1, 1, 'inventory_list', 'inventory_list', NULL, 'Y', NULL, NULL),
	(14, 'Picking', 'Picking', '2', 6, 1, 2, 'picking', 'picking', NULL, 'Y', 'atmi', '2022-09-27 15:05:11'),
	(28, 'Unit', 'Unit', '2', 9, 1, 8, 'master_unit', 'master_unit', NULL, 'Y', 'backdoor', '2023-03-14 09:59:59'),
	(27, 'Transporter', 'Transporter', '2', 9, 1, 7, 'master_transporter', 'master_transporter', NULL, 'Y', 'backdoor', '2023-03-14 09:59:33'),
	(26, 'Commodity', 'Commodity', '2', 9, 1, 6, 'master_commodity', 'master_commodity', NULL, 'Y', 'backdoor', '2023-03-14 09:58:57'),
	(13, 'Outbound Planning', 'Outbound Planning', '2', 6, 1, 1, 'outbound_planning', 'outbound_planning', NULL, 'Y', 'atmi', '2022-09-27 15:05:11'),
	(12, 'Goods Receiving', 'Goods Receiving', '2', 1, 1, 2, 'goods_receiving', 'goods_receiving', NULL, 'Y', 'atmi', '2022-09-27 15:05:11'),
	(11, 'Inbound Planning', 'Inbound Planning', '2', 1, 1, 1, 'inbound_planning', 'inbound_planning', NULL, 'Y', 'atmi', '2022-09-27 15:05:11'),
	(10, 'Setting', 'Setting', '2', 0, 1, 9, 'setting', NULL, 'https://static.rpx.co.id/wms_web_dev/logo/Setting.png', 'Y', 'atmi', '2022-09-27 15:05:11'),
	(9, 'Master', 'Master Data', '2', 0, 1, 8, 'master', NULL, 'https://static.rpx.co.id/wms_web_dev/logo/master_data.png', 'Y', 'atmi', '2022-09-27 15:05:11'),
	(8, 'Finance', 'Finance', '2', 0, 1, 6, 'finance', NULL, NULL, 'Y', 'atmi', '2022-09-27 15:05:11'),
	(7, 'Order Management', 'Order Management', '2', 0, 1, 5, 'order_management', NULL, NULL, 'Y', 'atmi', '2022-09-27 15:05:11'),
	(6, 'Outbound', 'Outbound', '2', 0, 1, 4, 'outbound', NULL, 'https://static.rpx.co.id/wms_web_dev/logo/Outbound_Menu.png', 'Y', 'atmi', '2022-09-27 15:05:11'),
	(5, 'Inventory', 'Inventory', '2', 0, 1, 3, 'inventory', NULL, 'https://static.rpx.co.id/wms_web_dev/logo/Inventory_menu.png', 'Y', 'atmi', '2022-09-27 15:05:11'),
	(4, 'Dashboard', 'Dashboard WMS', '2', 0, 1, 1, 'dashboard', 'dashboard', 'https://static.rpx.co.id/wms_web_dev/logo/DASHBOARD.png', 'Y', 'atmi', '2022-09-27 15:05:11'),
	(3, 'Cek & Receive', 'Inbound Check and Receive', '1', 0, 0, 1, 'cek_n_receive', NULL, NULL, 'Y', 'rdarmawan', '2022-09-23 11:06:20'),
	(2, 'Putaway', 'Putaway', '1', 0, 0, 2, 'putaway', '/putaway', NULL, 'Y', 'rdarmawan', '2022-09-23 11:07:04'),
	(1, 'Inbound', 'Inbound', '2', 0, 1, 2, 'inbound', NULL, 'https://static.rpx.co.id/wms_web_dev/logo/Inbound_Menu.png', 'Y', 'rdarmawan', '2022-09-23 11:06:20'),
	(32, 'Report', 'Report', '2', 0, 1, 7, 'report', NULL, 'https://static.rpx.co.id/wms_web_dev/logo/Report.png', 'Y', 'backdoor', '2023-03-27 13:42:17'),
	(33, 'Summary Inbound', 'Summary Inbound', '2', 32, 1, 1, 'report_summary_inbound', 'report_summary_inbound', NULL, 'Y', 'backdoor', '2023-03-27 13:42:53'),
	(34, 'Summary Outbound', 'Summary Outbound', '2', 32, 1, 2, 'report_summary_outbound', 'report_summary_outbound', NULL, 'Y', 'backdoor', '2023-03-29 07:40:58'),
	(35, 'Movement Report', 'Movement Report', '2', 32, 1, 3, 'movement_report', 'movement_report', NULL, 'Y', 'backdoor', '2023-03-30 08:06:26'),
	(36, 'Client', 'Client', '2', 9, 1, 1, 'master_client', 'master_client', NULL, 'Y', 'backdoor', '2023-05-02 13:46:43'),
	(37, 'Contact', 'Contact', '2', 9, 1, 12, 'master_contact', 'master_contact', NULL, 'Y', 'backdoor', '2023-03-14 09:59:59'),
	(38, 'Buffer', 'Buffer', '2', 9, 1, 11, 'master_buffer', 'master_buffer', NULL, 'Y', 'backdoor', '2023-05-19 10:32:22'),
	(39, 'Return', 'Return', '2', 1, 1, 3, 'return', 'return', NULL, 'Y', 'backdoor', '2023-05-22 15:34:54'),
	(40, 'GR Return', 'GR Return', '2', 1, 1, 4, 'gr_return', 'gr_return', NULL, 'Y', 'backdoor', '2023-06-12 09:27:10');
...
CREATE TABLE IF NOT EXISTS `m_status_relation` (
  `status_relation_id` int(3) NOT NULL DEFAULT '0',
  `status_id` varchar(3) NOT NULL DEFAULT '',
  `is_active` enum('Y','N') NOT NULL DEFAULT 'Y',
  `user_created` varchar(50) DEFAULT NULL,
  `datetime_created` datetime DEFAULT NULL,
...
-- Dumping data for table wms.m_user_menu_access: 220 rows
...
CREATE TABLE IF NOT EXISTS `m_warehouse` (
  ...
  KEY `id` (`wh_id`),
  KEY `wh_id` (`wh_code`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COMMENT='master warehouse';
...
CREATE TABLE IF NOT EXISTS `m_wh_buffer` (
  `buffer_id` int(10) NOT NULL AUTO_INCREMENT,
  `contact_id` int(11) NOT NULL DEFAULT '0',
  `sku` varchar(20) DEFAULT NULL,
  `qty_buffer` int(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_wh_client` (
  ...
  `account_number` int(50) DEFAULT NULL,
  `methods_id` int(10) DEFAULT NULL,
  `user_created` varchar(20) DEFAULT NULL,
  `datetime_created` datetime DEFAULT NULL,
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='master client warehouse';
...
CREATE TABLE IF NOT EXISTS `m_wh_client_project` (
  ...
  `client_id` varchar(20) NOT NULL,
  `wh_id` int(10) NOT NULL DEFAULT '0',
  `project_type_id` int(5) NOT NULL DEFAULT '0',
  ...
  KEY `wh_id` (`wh_id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='project client warehouse';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='master item warehouse';
...
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=latin1 COMMENT='master lokasi warehouse';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Tipe Lokasi Warehouse';
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='tipe order customer warehouse';
...
CREATE TABLE IF NOT EXISTS `m_wh_project_type` (
  `project_type_id` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `m_wh_stock_type` (
  ...
  KEY `process_id` (`process_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Stock Type';
...
CREATE TABLE IF NOT EXISTS `m_wh_stock_type_copy` (
  ...
  `is_active` enum('Y','N') DEFAULT NULL,
  PRIMARY KEY (`stock_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='Stock Type';
...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COMMENT='master supplier warehouse';
...
CREATE TABLE IF NOT EXISTS `m_wh_transporter` (
  `transporter_id` int(5) NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='list user level';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='vehicle that usually used to carry goods in/out from warehouse';
...
-- Dumping data for table wms.t_running_number: 74 rows
...
CREATE TABLE IF NOT EXISTS `t_wh_adjustment_detail` (
  ...
  `stock_id` varchar(10) NOT NULL DEFAULT '',
  `adjustment_qty` int(5) DEFAULT '0',
  `final_qty` int(5) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `t_wh_checking_transport_loading` (
  ...
  `transporter_id` int(5) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_wh_inbound_detail` (
  ...
  `qty` int(10) DEFAULT NULL,
  `discrepancy` int(10) DEFAULT NULL,
  `uom_name` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_wh_inbound_planning` (
  `inbound_planning_no` varchar(50) NOT NULL DEFAULT '',
  `wh_id` bigint(20) unsigned DEFAULT NULL,
  `client_project_id` int(11) unsigned NOT NULL DEFAULT '0',
...
-- Dumping data for table wms.t_wh_inbound_planning: 67 rows
...
INSERT INTO `t_wh_inbound_planning` (`inbound_planning_no`, `wh_id`, `client_project_id`, `supplier_id`, `status_id`, `reference_no`, `receipt_no`, `plan_delivery`, `order_id`, `task_type`, `remarks`, `data_upload1`, `data_upload2`, `data_upload3`, `is_active`, `is_deleted`, `user_created`, `datetime_created`, `user_updated`, `datetime_updated`) VALUES
	...
	('CBT-IN-0623-0002', 1, 1, 1, 'OPI', 'test_inbound', 'test_inbound', '2023-06-26 00:00:00', '1', 'Single Receive', NULL, '', '', '', 'Y', 'N', 'atmi', '2023-06-26 14:28:31', NULL, NULL),
	('CBT-IN-0623-0003', 1, 1, 1, 'OPI', 'test_2', 'test_2', '2023-06-26 00:00:00', '1', 'Single Receive', NULL, '', '', '', 'Y', 'N', 'atmi', '2023-06-26 14:49:30', NULL, NULL);
...
-- Dumping data for table wms.t_wh_inbound_planning_detail: 89 rows
...
CREATE TABLE IF NOT EXISTS `t_wh_inbound_planning_detail_2` (
  `id` bigint(10) unsigned NOT NULL AUTO_INCREMENT,
  `inbound_id` bigint(10) DEFAULT NULL,
  ...
  `size` varchar(50) DEFAULT NULL,
  `expired_date` datetime DEFAULT NULL,
  `qty_plan` int(10) DEFAULT NULL,
  `qty_receive` int(10) DEFAULT NULL,
  `discrepancy` int(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `t_wh_location_inventory` (
  ...
  `expired_date` date DEFAULT NULL,
  `clasification_id` int(11) DEFAULT NULL,
  `on_hand_qty` int(10) DEFAULT '0',
  `allocated_qty` int(10) DEFAULT '0',
  `picked_qty` int(10) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `t_wh_log_api` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='API Inbound';
...
CREATE TABLE IF NOT EXISTS `t_wh_outbound_detail_sku` (
  ...
  `allocated_qty` int(10) DEFAULT NULL,
  `expired_date` date DEFAULT NULL,
  `user_created` varchar(50) DEFAULT NULL,
  `datetime_created` datetime DEFAULT NULL,
...
INSERT INTO `t_wh_outbound_planning` (`outbound_planning_no`, `wh_id`, `client_project_id`, `supplier_id`, `order_id`, `status_id`, `reference_no`, `receipt_no`, `plan_delivery`, `notes`, `cancel_reason`, `user_created`, `datetime_created`, `user_updated`, `datetime_updated`) VALUES
	...
	('CBT-OUT-0623-0006', 1, 1, 1, '1', 'UNO', 'test_outbound_3006_3', 'test_outbound_3006_3', '2023-06-30', NULL, NULL, 'mariofrans_spv', '2023-06-30 10:16:44', NULL, NULL);
...
-- Dumping data for table wms.t_wh_picking: 46 rows
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='checking and receiving';

-- Dumping data for table wms.t_wh_receive: 44 rows
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='checking and receiving';
...
CREATE TABLE IF NOT EXISTS `t_wh_scan_checking` (
  `scan_id` int(25) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `t_wh_scan_qty` (
  ...
  KEY `uom_id` (`uom_name`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=209 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='master supervisor per warehouse';
...
) ENGINE=MyISAM AUTO_INCREMENT=92 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='sub menu transportation and unloading on inbound planning';
...
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=latin1 COMMENT='sub menu transportation and unloading on inbound planning';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='master user warehouse';

-- Dumping data for table wms.t_wh_user: 11 rows
...
INSERT INTO `t_wh_user` (`username`, `user_level_id`, `fullname`, `password`, `wh_id`, `email`, `phone`, `send_email`, `created_by`, `created_on`, `last_login`, `use_hht`, `is_active`, `is_deleted`, `is_android`, `is_web`, `remember_token`) VALUES
	('atmi', 2, 'nur atmi pertiwi', '$2y$10$q94x6NvmvY6eAagaLBlaauPMrcb5o.0S.RUK497nE.mf6//xGL8Te', 1, 'npertiwi@rpxholding.com', NULL, 'N', NULL, NULL, NULL, NULL, 'Y', NULL, 'Y', 'Y', NULL),
	('rdarmawan', 2, 'Roby Darmawan', '$2y$10$q94x6NvmvY6eAagaLBlaauPMrcb5o.0S.RUK497nE.mf6//xGL8Te', 1, NULL, NULL, 'N', NULL, NULL, '2022-10-11 09:43:17', 'Y', 'Y', NULL, 'Y', 'Y', NULL),
	('hari', 3, 'Hari Hari Bahagia', '$2y$10$q94x6NvmvY6eAagaLBlaauPMrcb5o.0S.RUK497nE.mf6//xGL8Te', 1, NULL, NULL, 'N', NULL, NULL, NULL, NULL, 'Y', NULL, 'Y', 'Y', NULL),
	...
	('alfian', 1, 'Alfian Ozawa', '$2y$10$LiP0cejdG.sRXg2ttC2...sqqZ5w6lhRmcGwAUO5jIBduaCayp6XC', 1, NULL, NULL, 'N', NULL, NULL, NULL, NULL, 'Y', NULL, 'Y', 'Y', NULL),
	('test_admin', 2, 'Test Admin', '$2y$10$q94x6NvmvY6eAagaLBlaauPMrcb5o.0S.RUK497nE.mf6//xGL8Te', 1, NULL, NULL, 'N', NULL, NULL, NULL, NULL, 'Y', NULL, 'Y', 'Y', NULL),
	('test_staff', 2, 'Test Staff', '$2y$10$q94x6NvmvY6eAagaLBlaauPMrcb5o.0S.RUK497nE.mf6//xGL8Te', 1, NULL, NULL, 'N', NULL, NULL, NULL, NULL, 'Y', NULL, 'Y', 'Y', NULL),
	('mariofrans_spv', 1, 'Mariofrans SPV', '$2y$10$q94x6NvmvY6eAagaLBlaauPMrcb5o.0S.RUK497nE.mf6//xGL8Te', 1, NULL, NULL, 'N', NULL, NULL, NULL, NULL, 'Y', NULL, 'Y', 'Y', NULL),
	('rdivianto', 1, 'Rizky Isa Divianto', 'ihjpJ2sFsAv.E', 1, 'rdivianto@rpxholding.com', '123', 'Y', 'atmi', '2023-03-10 16:51:42', NULL, NULL, 'Y', NULL, 'Y', 'Y', NULL),
	('bunga', 5, 'bunga dwi cahyati', '3UmvpNLgZpNfs', 1, NULL, NULL, 'Y', 'atmi', '2023-03-16 10:59:01', NULL, NULL, 'Y', NULL, 'Y', 'Y', NULL),
	('superadmin', 5, 'Super Admin', '$2y$10$Zn1INujHQ6BqLwAIEAJE..XHrg8UlmKgWoCj1TxHc0LHJ2.6EGSte', 1, NULL, NULL, 'Y', 'mariofrans', '2023-03-20 10:51:54', NULL, NULL, 'Y', NULL, 'Y', 'Y', NULL);
