                                ...
                                <div class="card-body py-0">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <select class="form-select py-0" id="warehouse" name="warehouse" multiple>
                                                        <option value="">Choose</option>
                                                        @if (isset($data['arr_warehouse']) && count($data['arr_warehouse']) > 0)
                                                        @foreach ( $data['arr_warehouse'] as $key_choice_warehouse => $warehouse )
...
$(document).ready(function () {
    ...
    $("#form-save-project").on("submit",function (e) {
        ...
        const temp_warehouse = $("#warehouse").val();
        ...
        temp_warehouse.forEach(element => {
            arr_warehouse.push(element);
        });
        ...
        formData.append("arr_warehouse",JSON.stringify(arr_warehouse));
