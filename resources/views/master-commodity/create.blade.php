            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 d-flex mb-2">
                        <h5 class="me-auto">Master Commodity - Create</h5>
                    ...
                    <hr>
                    <form method="POST" action="{{ route('master_commodity.store') }}" id="form-save-commodity">
                        <div class="col-sm-12 mb-2">
                            <div class="card">
                                <div class="card-body py-0">
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="commodity_name" name="commodity_name" value="">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <textarea class="form-control py-0" id="commodity_desc" name="commodity_desc" cols="30" rows="5"></textarea>
