            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 d-flex mb-2">
                        <h3 class="me-auto">Inbound Planning - Edit</h3>
                    ...
                    <hr>
                    <form method="POST" action="{{ route('inbound_planning.update' , [ 'id'=> $data["current_data"]->inbound_planning_no ]) }}" id="form-update-inbound">
                    @csrf
                    @method('POST')
                        <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2 ps-0">
                                                    <button type="button" class="btn btn-primary mb-0 rounded py-1" id="btn_search_supplier_id"><i class="bi bi-search"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3 mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="reference_no" name="reference_no" value="{{ $data["current_data"]->reference_no }}">
                                        ...
                                        <div class="col-sm-3 mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="receipt_no" name="receipt_no" value="{{ $data["current_data"]->receipt_no }}">
                                        ...
                                        <div class="col-sm-3 mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="date" autocomplete="off" class="form-control py-0" id="plan_delivery_date" name="plan_delivery_date" value="{{ date("Y-m-d",strtotime($data["current_data"]->plan_delivery)) }}" >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="task_type" id="task_type_single_receive" value="Single Receive" {{ (@$data["current_data"]->task_type == "Single Receive") ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="task_type_single_receive">
                                                            Single Receive
                                                        </label>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="task_type" id="task_type_partial_receive" value="Partial Receive" {{ (@$data["current_data"]->task_type == "Partial Receive") ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="task_type_partial_receive">
                                                            Partial Receive
                                                        </label>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body tab-content py-0">
                                                            ...
                                                            <tr id='table_item_detail_{{ $current_row }}'>
                                                                <td>
                                                                    <div class="input-group">
                                                                        ...
                                                                        <button type="button" class="btn btn-primary mb-0 rounded py-1" id="btn_search_sku_{{ $current_row }}" name="btn_search_sku_{{ $current_row }}" onclick="displayModalSKU('{{ $current_row }}')"><i class="bi bi-search"></i></button>
                                                                ...
                                                                <td>
                                                                    <input type='text' class='form-control py-0' name='batch_no[]' id='batch_no_{{ $current_row }}' value="{{ $current_data_detail->batch_no }}">
                                                                    <div id="validation_batch_no_{{ $current_row }}" class="invalid-feedback text-xs"></div>
                                                                </td>
                                                                <td>
                                                                    <input type='text' class='form-control py-0' name='serial_no[]' id='serial_no_{{ $current_row }}' value="{{ $current_data_detail->serial_no }}">
                                                                    <div id="validation_serial_no_{{ $current_row }}" class="invalid-feedback text-xs"></div>
                                                                </td>
                                                                <td>
                                                                    <input type='text' class='form-control py-0' name='imei_no[]' id='imei_no_{{ $current_row }}' value="{{ $current_data_detail->imei }}">
                                                                    <div id="validation_imei_no_{{ $current_row }}" class="invalid-feedback text-xs"></div>
                                                                </td>
                                                                <td>
                                                                    <input type='text' class='form-control py-0' name='part_no[]' id='part_no_{{ $current_row }}' value="{{ $current_data_detail->part_no }}">
                                                                    <div id="validation_part_no_{{ $current_row }}" class="invalid-feedback text-xs"></div>
                                                                </td>
                                                                <td>
                                                                    <input type='text' class='form-control py-0' name='color[]' id='color_{{ $current_row }}' value="{{ $current_data_detail->color }}">
                                                                    <div id="validation_color_{{ $current_row }}" class="invalid-feedback text-xs"></div>
                                                                </td>
                                                                <td>
                                                                    <input type='text' class='form-control py-0' name='size[]' id='size_{{ $current_row }}' value="{{ $current_data_detail->size }}">
                                                                ...
                                                                <td>
                                                                    <input type='date' class='form-control py-0' name='expired_date[]' id='expired_date_{{ $current_row }}' value="{{ (!empty($current_data_detail->expired_date)) ? date("Y-m-d",strtotime($current_data_detail->expired_date)) : "" }}">
                                                                ...
                                                                <td>
                                                                    <div class="input-group">  
                                                                        ...
                                                                        <button type="button" class="btn btn-primary mb-0 rounded py-1" id="btn_search_uom_{{ $current_row }}" name="btn_search_uom_{{ $current_row }}" onclick="displayModalUOM('{{ $current_row }}')"><i class="bi bi-search"></i></button>
                                                                        <div id="validation_uom_{{ $current_row }}" class="invalid-feedback text-xs"></div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <input type='text' class='form-control py-0' name='qty_plan[]' id='qty_plan_{{ $current_row }}' value="{{ $current_data_detail->qty }}">
                                                                ...
                                                                <td>
                                                                    <div class="input-group">  
                                                                        ...
                                                                        <button type="button" class="btn btn-primary mb-0 rounded py-1" id="btn_search_classification_{{ $current_row }}" name="btn_search_classification_{{ $current_row }}" onclick="displayModalClassification('{{ $current_row }}')"><i class="bi bi-search"></i></button>
                                                                        <div id="validation_classification_{{ $current_row }}" class="invalid-feedback text-xs"></div>
                                                                    </div>
                                                                </td>
                                                                <td class='text-center'>
                                                                    <button type='button' class='btn btn-primary mb-0 py-1' id='btn_delete_{{ $current_row }}' name='btn_delete_{{ $current_row }}' onclick='deleteRowTableItemDetail("{{ $current_row }}")'>Delete</button>
                                                                </td>
                                                            </tr>
                                                            @endforeach    
                                                            @endif
                                    ...
                                    <div class="tab-pane" id="page-tab--notes">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <textarea name="remarks" id="remarks" rows="10" class="form-control py-0">{{ $data["current_data"]->remarks }}</textarea>
                                            </div>
                                        </div>
                                    </div>
...
$(document).ready(function () {
    ...
    let row_Table_Item_Detail = parseInt("{{ $current_row }}");
    ...
    $("#form-update-inbound").on("submit",function (e) {
        e.preventDefault();
