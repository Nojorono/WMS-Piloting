            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 d-flex mb-2">
                        <h5 class="me-auto">Master Transporter</h5>
                        @if (in_array(session('user_level_id'),[1,2,5]))
                        <a href="{{route('master_transporter.create')}}" class="text-decoration-none">
...
$(document).ready(function () {
    ...
    const searchDatatables = () => {
        ...
        $("#list-datatable").DataTable({
            ...
            ordering: false,
            ajax: {
                url: "{{route('master_transporter.datatables')}}",
