            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 d-flex mb-2">
                        <h5 class="me-auto">Master Location - Create</h5>
                    ...
                    <hr>
                    <form method="POST" action="{{ route('master_location.store') }}" id="form-save-location">
                        <div class="col-sm-12 mb-2">
                            <div class="card">
                                <div class="card-body py-0">
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="location_code" name="location_code" value="">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="location_name" name="location_name" value="">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-10">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="location_index" name="location_index" value="" readonly>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <select class="form-select py-0" id="location_type" name="location_type">
                                                        ...
                                                        <option value="{{ $value_choice_location_type->type_name }}"> {{ $value_choice_location_type->type_name }}</option>
                                                        @endforeach
                                                        @endif
                                                    </select>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <select class="form-select py-0" id="project" name="project">
                                                        <option value="">Choose</option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-10">
                                                    <input type="hidden" id="commodity_id" name="commodity_id" value="" readonly>
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="commodity_name" name="commodity_name" value="" readonly>
