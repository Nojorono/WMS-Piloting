        ...
        <table class="" style="width: 100%;">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 20%;">{{ session("current_client_name") }}</td>
                    <th style="width: 20%; text-align:left;">Warehouse Name</th>
                    <td style="width: 20%;">{{ session("current_warehouse_name") }}</td>
                </tr>
                <tr>
                    ...
                    <td style="width: 20%;">{{ @$data["current_data_detail"][0]->warehouseman }}</td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <table class="custom-table--bordered" style="width: 100%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        {{ $current_data_detail->dest_location_id }}
                    </td>
                    <td style="text-align: center;">
                        {{ $current_data_detail->dest_location_type }}
                    </td>
                </tr>
                @php
