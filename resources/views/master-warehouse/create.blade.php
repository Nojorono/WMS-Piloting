            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 d-flex mb-2">
                        <h5 class="me-auto">Master Warehouse - Create</h5>
                    ...
                    <form method="POST" action="{{ route('master_warehouse.store') }}" id="form-save-warehouse">
                        <div class="col-sm-12 mb-2">
                            <div class="card">
                                <div class="card-body py-0">
                                    <div class="row">
                                        <div class="col-sm-12 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="warehouse_code" name="warehouse_code" value="">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="warehouse_prefix" name="warehouse_prefix" value="">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="warehouse_address_1" name="warehouse_address_1" value="">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="warehouse_address_2" name="warehouse_address_2" value="">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="warehouse_address_3" name="warehouse_address_3" value="">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <select class="form-select py-0" id="is_rpx_warehouse" name="is_rpx_warehouse">
                                                        ...
                                                        <option value="{{ $key_choice_is_rpx_warehouse }}"> {{ $value_choice_is_rpx_warehouse }}</option>
                                                        @endforeach
                                                        @endif
                                                    </select>
...
$(document).ready(function () {
    ...
    $("#form-save-warehouse").on("submit",function (e) {
        ...
        const warehouse_prefix = $("#warehouse_prefix").val();
        ...
        const is_rpx_warehouse = $("#is_rpx_warehouse").val();
        ...
        formData.append("warehouse_prefix",warehouse_prefix);
        ...
        formData.append("is_rpx_warehouse",is_rpx_warehouse);
        ...
        $.ajax({
            ...
            cache: false,
            beforeSend: function () {
                $("#warehouse_code").removeClass('is-invalid');
                $("#validation_warehouse_code").html('');
                $("#warehouse_prefix").removeClass('is-invalid');
                $("#validation_warehouse_prefix").html('');
                ...
                $("#is_rpx_warehouse").removeClass('is-invalid');
                $("#validation_is_rpx_warehouse").html('');
