...
<div class="row">
    <div class="col-sm-12 mb-2">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('gr_return.processReceiveDetail' , [ 'id'=> $data["current_data_header_movement_location"][0]->gr_return_id ]) }}" id="form-putaway">
                    <div class="row">
                        <div class="col-sm-12 d-flex mb-2">
                            <h5 class="me-auto">GR Return Putaway Location - Show</h5>
                            <a href="{{route('gr_return.show',['id' =>  $data["current_data_header_movement_location"][0]->gr_return_id ])}}" class="text-decoration-none me-2">
                                <button type="button" class="btn btn-primary mb-0 py-1">Show</button>
                            </a>
                            <span class="text-decoration-none me-2">
                                <button type="button" class="btn btn-primary mb-0 py-1" id="btn_print_putaway" name="btn_print_putaway">Print Putaway</button>
                            </span>
                        </div>
                        <div class="col-sm-12 mb-2">
                            <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control py-0" id="gr_return_id" name="gr_return_id" value="{{ @$data["current_data_header_movement_location"][0]->gr_return_id }}" readonly>
                                        ...
                                        <div class="col-sm-3 mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="movement_location_id" name="movement_location_id" value="{{ @$data["current_data_header_movement_location"][0]->movement_id }}" readonly>
                                                    <div id="validation_movement_location_id" class="invalid-feedback text-xs"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3 mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="reference_no" name="reference_no" value="{{ @$data["current_data_header_movement_location"][0]->reference_no }}" readonly>
                                        ...
                                        <div class="col-sm-3 mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" autocomplete="off" class="form-control py-0" id="movement_date" name="movement_date" value="{{ @$data["current_data_header_movement_location"][0]->movement_date }}" readonly>
                                                    <div id="validation_movement_date" class="invalid-feedback text-xs"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body tab-content py-0">
                                    <div class="row mb-2">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <button type="button" class="btn btn-primary mb-0 py-1" id="btn_add_row_detail" name="btn_add_row_detail">Add Row</button>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 mb-2" id="container-item-detail">
                                            <div class="table-responsive">
                                                <table class="table " id="tabel-item-detail" style="min-width: calc(2.5 * 100%);">
                                                    ...
                                                    <tbody>
                                                        @if (isset($data["current_data_detail_movement_location"]) && count($data["current_data_detail_movement_location"]) > 0)
                                                        @php
                                                            $row_Table_Item_Detail = 0;
                                                        @endphp
                                                        @foreach ($data["current_data_detail_movement_location"] as $detail)
                                                        @php
                                                        ...
                                                        <tr id='table_item_detail_{{ $row_Table_Item_Detail }}'>
                                                            <td>
                                                                <div class="input-group">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary mb-0 rounded py-1" onclick="displayModalListSKUByGR('{{ $row_Table_Item_Detail }}')"><i class="bi bi-search"></i></button>
                                                            ...
                                                            <td>
                                                                <input type='text' class='form-control py-0' name='qty[]' id='qty_{{ $row_Table_Item_Detail }}' value="{{ @$detail->qty }}">
                                                                <div id="validation_qty_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                            </td>
                                                            <td>
                                                                <input type='text' class='form-control py-0' name='uom_name[]' id='uom_name_{{ $row_Table_Item_Detail }}' value="{{ @$detail->uom_name }}" readonly>
                                                                <div id="validation_uom_name_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                            </td>
                                                            <td>
                                                                <div class="input-group">
                                                                    <input type='text' class='form-control py-0' name='dest_location_id[]' id='dest_location_id_{{ $row_Table_Item_Detail }}' value="{{ @$detail->dest_location_id }}" readonly>
                                                                    <button type="button" class="btn btn-primary mb-0 rounded py-1" onclick="displayModalDestLocation('{{ $row_Table_Item_Detail }}')"><i class="bi bi-search"></i></button>

                                                                    <div id="validation_dest_location_id_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <input type='text' class='form-control py-0' name='dest_location_type[]' id='dest_location_type_{{ $row_Table_Item_Detail }}' value="{{ @$detail->dest_location_type }}" readonly>
                                                                <div id="validation_dest_location_type_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                            </td>
                                                            <td>
                                                                <input type='text' class='form-control py-0' name='stock_id[]' id='stock_id_{{ $row_Table_Item_Detail }}' value="{{ @$detail->stock_id }}" readonly>
                                                                <div id="validation_stock_id_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                            </td>
                                                            <td>
                                                                <div class="input-group">
                                                                    <input type='text' class='form-control py-0' name='warehouseman_assigned[]' id='warehouseman_assigned_{{ $row_Table_Item_Detail }}' value="{{ @$detail->warehouseman }}" readonly>
                                                                    <button type="button" class="btn btn-primary mb-0 rounded py-1" onclick="displayModalAssignedUserWarehouseman('{{ $row_Table_Item_Detail }}')"><i class="bi bi-search"></i></button>
                                                                    <div id="validation_warehouseman_assigned_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <button class="btn btn-primary mb-0 py-1" onclick="deleteRow_detail('{{ $row_Table_Item_Detail }}')">Delete</button>
                                                            </td>
                                                        </tr>
                                                        @php
                                                            $row_Table_Item_Detail++;
...
<div class="modal fade" id="modal-AssignToWarehouseman" tabindex="-1" aria-labelledby="modal-AssignToWarehousemanLabel" aria-hidden="true" >
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form method="POST" action="{{ route('gr_return.processAssignWarehouseman' , [ 'id' => $data["current_data_header_movement_location"][0]->gr_return_id ]) }}" id="form-assign-warehouseman">
            @csrf
            @method('POST')
                <div class="card">
                    <div class="card-body">
...
function displayModalAssignedUserWarehouseman(row) {
    ...
    $("#tabel-TargetAssignedWarehouseman").DataTable({
        ...
        serverSide: true,
        ordering: false,
        ajax: "{{ route('gr_return.datatablesTargetWarehousemanAssign',['id' => @$data['current_data_header_movement_location'][0]->gr_return_id]) }}",
        columns:[
            {
                data: 'checker', 
                searchable: true,
...
function displayModalDestLocation(row) {
    ...
    $("#tabel-DestLocation").DataTable({
        ...
        serverSide: true,
        ordering: false,
        ajax: "{{ route('gr_return.datatablesDestLocation') }}",
        columns:[
            {
...
function displayModalTargetUserWarehouseman(row) {
    ...
    $("#tabel-TargetUserWarehouseman").DataTable({
        ...
        serverSide: true,
        ordering: false,
        ajax: "{{ route('gr_return.datatablesTargetUserAssign') }}",
        columns:[
            {
                data: 'username', 
                searchable: true,
...
function displayModalListSKUByGR(row) {
    ...
    $("#tabel-ListSKUByGR").DataTable({
        ...
        serverSide: true,
        ordering: false,
        ajax: "{{ route('gr_return.datatablesListSKUByGR' , [ 'id'=> @$data['current_data_header_movement_location'][0]->gr_return_id ]) }}",
        columns:[
            {
                data: 'sku', 
                searchable: true,
...
$(document).ready(function() {
    ...
    let row_Table_Item_Detail = "{{ $row_Table_Item_Detail }}";
    ...
    $("#btn_assign_to_warehouseman").on("click",function () {
        $("#modal-AssignToWarehouseman").modal({backdrop: 'static', keyboard: false});
    ...
    $("#btn_add_row_warehouseman").on("click",function () {
        ...
        <tr id="row_warehouseman_${row_count_warehouseman}">
            ...
            <td>
                <button type="button" class="btn btn-primary mb-0 py-1" name="btn_delete_row_warehouseman_${row_count_warehouseman}" id="btn_delete_row_warehouseman_${row_count_warehouseman}" onclick="deleteRowWarehouseman('${row_count_warehouseman}')">Delete</button>
            </td>
        </tr>`;
    ...
    $("#btn_add_row_detail").on("click",function () {
        row_Table_Item_Detail = parseInt(row_Table_Item_Detail);
        const html_row_putaway_detail = `
        <tr id="table_item_detail_${row_Table_Item_Detail}">
            <td>
                <div class="input-group">  
                    <input type='text' class='form-control py-0' name='sku[]' id='sku_${row_Table_Item_Detail}' value="" readonly>
                    <button type="button" class="btn btn-primary mb-0 rounded py-1" onclick="displayModalListSKUByGR('${row_Table_Item_Detail}')"><i class="bi bi-search"></i></button>
                    <div id="validation_sku_${row_Table_Item_Detail}" class="invalid-feedback text-xs"></div>
                </div>
            </td>
            <td>
                <input type='text' class='form-control py-0' name='item_name[]' id='item_name_${row_Table_Item_Detail}' value="">
                <div id="validation_item_name_${row_Table_Item_Detail}" class="invalid-feedback text-xs"></div>
            </td>
            <td>
                <input type='text' class='form-control py-0' name='batch_no[]' id='batch_no_${row_Table_Item_Detail}' value="" readonly>
                <div id="validation_batch_no_${row_Table_Item_Detail}" class="invalid-feedback text-xs"></div>
            </td>
            <td>
                <input type='text' class='form-control py-0' name='expired_date[]' id='expired_date_${row_Table_Item_Detail}' value="" readonly>
                <div id="validation_expired_date_${row_Table_Item_Detail}" class="invalid-feedback text-xs"></div>
            </td>
            <td>
                <input type='text' class='form-control py-0' name='qty[]' id='qty_${row_Table_Item_Detail}' value="">
                <div id="validation_qty_${row_Table_Item_Detail}" class="invalid-feedback text-xs"></div>
            </td>
            <td>
                <input type='text' class='form-control py-0' name='uom[]' id='uom_${row_Table_Item_Detail}' value="" readonly>
                <div id="validation_uom_${row_Table_Item_Detail}" class="invalid-feedback text-xs"></div>
            </td>
            <td>
                <div class="input-group">  
                    <input type='text' class='form-control py-0' name='dest_location_id[]' id='dest_location_id_${row_Table_Item_Detail}' value="" readonly>
                    <button type="button" class="btn btn-primary mb-0 rounded py-1" onclick="displayModalDestLocation('${row_Table_Item_Detail}')"><i class="bi bi-search"></i></button>
                    <div id="validation_dest_location_id_${row_Table_Item_Detail}" class="invalid-feedback text-xs"></div>
                </div>
            </td>
            <td>
                <input type='text' class='form-control py-0' name='dest_location_type[]' id='dest_location_type_${row_Table_Item_Detail}' value="" readonly>
                <div id="validation_dest_location_type_${row_Table_Item_Detail}" class="invalid-feedback text-xs"></div>
            </td>
            <td>
                <input type='text' class='form-control py-0' name='stock_id[]' id='stock_id_${row_Table_Item_Detail}' value="" readonly>
                <div id="validation_stock_id_${row_Table_Item_Detail}" class="invalid-feedback text-xs"></div>
            </td>
            <td>
                <div class="input-group">
                    <input type='text' class='form-control py-0' name='warehouseman_assigned[]' id='warehouseman_assigned_${row_Table_Item_Detail}' value="" readonly>
                    <button type="button" class="btn btn-primary mb-0 rounded py-1" onclick="displayModalAssignedUserWarehouseman('${row_Table_Item_Detail}')"><i class="bi bi-search"></i></button>
                    <div id="validation_warehouseman_assigned_${row_Table_Item_Detail}" class="invalid-feedback text-xs"></div>
                </div>
            ...
            <td>
                <button type="button" class="btn btn-primary mb-0 py-1" onclick="deleteRow_putaway_detail('${row_Table_Item_Detail}')">Delete</button> 
            </td>
        </tr>`;
        row_Table_Item_Detail++;
        $("#tabel-item-detail > tbody").append(html_row_putaway_detail);
    });
    ...
    $("#tabel-PrintPutawayWarehouseman > tbody").on('click','tr',function () {
        ...
        const username = $($(dom_tr).children("td")[0]).text();
        const url = "{{ route('gr_return.printPutaway' , [ 'id' => $data['current_data_header_movement_location'][0]->gr_return_id,]) }}";
