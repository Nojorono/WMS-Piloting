            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 d-flex mb-2">
                        <h5 class="me-auto">User Group Management</h5>
                        @if (in_array(session('user_level_id'),[1,5]))
                        <a href="{{route('user_group_management.create')}}" class="text-decoration-none">
...
$(document).ready(function () {
    ...
    const searchDatatables = () => {
        ...
        $("#list-datatable").DataTable({
            ...
            ordering: false,
            ajax: {
                url: "{{route('user_group_management.datatables')}}",
