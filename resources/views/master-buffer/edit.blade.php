            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 d-flex mb-2">
                        <h5 class="me-auto">Master Buffer - Edit</h5>
                        <span>
                            <button type="button" class="btn btn-primary mb-0 py-1" id="btn_list">List</button>
                        </span>
                    </div>
                    <hr>
                    <form method="POST" action="{{ route('master_buffer.update',['id' => @$data['current_data'][0]->buffer_id, ]) }}" id="form-save-buffer">
                        <div class="col-sm-12 mb-2">
                            <div class="card">
                                <div class="card-body py-0">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 mb-2">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-sm-6">
                                                    <input type="number" autocomplete="off" class="form-control py-0" id="buffer_qty" name="buffer_qty" value="{{ @$data['current_data'][0]->qty_buffer }}">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <textarea class="form-control py-0" id="messages" style="height: 100px" name="messages">{{ @$data['current_data'][0]->messages }}</textarea>
