                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="date" autocomplete="off" class="form-control py-0 rounded-start" id="movement_date" name="movement_date" value="" required>
                ...
                <div class="row">
                    <div class="col-sm-12 mb-2">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-2">
                                <button type="button" class="btn btn-primary mb-0 py-1" name="btn_search_modal_item_detail" id="btn_search_modal_item_detail">List Item</button>
                            </div>
                        </div>
                        <div class="row align-items-center mb-2">
                            <div class="col-sm-3">
                                <!-- <button type="button" class="btn btn-primary mb-0 py-1" name="btn_add_modal_item_detail" id="btn_add_modal_item_detail">Add Item</button> -->
                            </div>
                    ...
                    <div class="row align-items-center mt-3">
                        <div class="col-sm-12 text-center">
                            <button type="button" class="btn btn-primary mb-0 py-1" name="btn_add_modal_item_detail" id="btn_add_modal_item_detail">Add Item for Movement</button>
                        </div>
                    </div>
                </div>
            </div>
