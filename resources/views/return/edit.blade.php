            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 d-flex mb-2">
                        <h3 class="me-auto">Return - Edit</h3>
                        <a href="{{route('return.show' , ['id' => @$data["current_data_header"][0]->return_no, ])}}" class="text-decoration-none me-2">
                            <button type="button" class="btn btn-primary mb-0 py-1">Show</button>
                        </a>
                    </div>
                    <hr>
                    <form method="POST" action="{{ route('return.update',['id' => @$data["current_data_header"][0]->return_no, ]) }}" id="form-save">
                    <div class="col-sm-12 mb-2">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 mb-2">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="date" class="form-control py-0" id="return_date" name="return_date" value="{{ @$data["current_data_header"][0]->return_date }}">
                                    ...
                                    <div class="col-sm-3 mb-2">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" autocomplete="off" class="form-control py-0" id="return_from" name="return_from" value="{{ @$data["current_data_header"][0]->return_from }}">
                                    ...
                                    <div class="col-sm-3 mb-2">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" autocomplete="off" class="form-control py-0" id="awb_number" name="awb_number" value="{{ @$data["current_data_header"][0]->awb }}">
                                    ...
                                    <div class="col-sm-3 mb-2">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" autocomplete="off" class="form-control py-0" id="reference_no" name="reference_no" value="{{ @$data["current_data_header"][0]->reference_no }}">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body tab-content py-0">
                                                ...
                                                <table class="table " id="tabel-item-detail" style="min-width: calc(2.5 * 100%);">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr id='table_item_detail_{{ $row_Table_Item_Detail }}'>
                                                            ...
                                                            <td>
                                                                <input type='text' class='form-control py-0' name='batch_no[]' id='batch_no_{{ $row_Table_Item_Detail }}' value="{{ @$detail->batch_no }}">
                                                                <div id="validation_batch_no_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                            </td>
                                                            <td>
                                                                <input type='text' class='form-control py-0' name='serial_no[]' id='serial_no_{{ $row_Table_Item_Detail }}' value="{{ @$detail->serial_no }}">
                                                                <div id="validation_serial_no_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                            </td>
                                                            <td>
                                                                <input type='date' class='form-control py-0' name='expired_date[]' id='expired_date_{{ $row_Table_Item_Detail }}' value="{{ @$detail->expired_date }}">
                                                                <div id="validation_expired_date_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                            </td>
                                                            <td>
                                                                <input type='text' class='form-control py-0' name='part_no[]' id='part_no_{{ $row_Table_Item_Detail }}' value="{{ @$detail->part_no }}">
                                                                <div id="validation_part_no_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                            </td>
                                                            <td>
                                                                <input type='text' class='form-control py-0' name='imei_no[]' id='imei_no_{{ $row_Table_Item_Detail }}' value="{{ @$detail->imei }}">
                                                                <div id="validation_imei_no_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                            </td>
                                                            <td>
                                                                <input type='text' class='form-control py-0' name='color[]' id='color_{{ $row_Table_Item_Detail }}' value="{{ @$detail->color }}">
                                                                <div id="validation_color_{{ $row_Table_Item_Detail }}" class="invalid-feedback text-xs"></div>
                                                            </td>
                                                            <td>
                                                                <input type='number' class='form-control py-0' name='qty[]' id='qty_{{ $row_Table_Item_Detail }}' value="{{ @$detail->qty }}">
                                                            ...
                                                            <td>
                                                                <input type='text' class='form-control py-0' name='item_reason[]' id='item_reason_{{ $row_Table_Item_Detail }}' value="{{ @$detail->item_reason }}">
                                ...
                                <div class="tab-pane" id="page-tab--reason">
                                    <div class="row mb-2">
                                        <div class="col-sm-12 mb-2">
                                            <textarea class="form-control py-0" name="reason" id="reason" cols="30" rows="10">{{ @$data["current_data_header"][0]->reason }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
let row_Table_Item_Detail = parseInt("{{ $row_Table_Item_Detail }}");
...
function addRowTableDetail(sku = "" , batch_no = "", expired_date = "", qty = "", uom_name = "") {
    ...
    <tr id='table_item_detail_${row_Table_Item_Detail}'>
        ...
        <td class="text-center">
            <button type='button' class='btn btn-primary' id='btn_delete_${row_Table_Item_Detail}' name='btn_delete_${row_Table_Item_Detail}' onclick='deleteRowTableItemDetail("${row_Table_Item_Detail}")'>Delete</button>
        </td>
    </tr>
    `;
    ...
    $("#form-save").on("submit",function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                window.location = "{{ route('return.show' , ['id' => @$data['current_data_header'][0]->return_no, ]) }}";
                return;
