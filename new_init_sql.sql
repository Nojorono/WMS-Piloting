...
CREATE DATABASE IF NOT EXISTS `wms` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
USE `wms`;
...
-- Dumping data for table wms.m_item_uom: 12 rows
...
-- Dumping data for table wms.m_user_menu_access: 79 rows
...
-- Dumping data for table wms.m_wh_item: 12 rows
...
-- Dumping data for table wms.m_wh_user_client_project: 32 rows
...
-- Dumping data for table wms.m_wh_user_project: 5 rows
/*!40000 ALTER TABLE `m_wh_user_project` DISABLE KEYS */;
INSERT INTO `m_wh_user_project` (`user_project_id`, `username`, `client_id`, `created_by`, `created_on`, `is_active`, `is_deleted`) VALUES
	(1, 'atmi', 1, 'atmi', '2022-09-28 18:15:02', 'Y', NULL),
	(2, 'rdarmawan', 1, 'atmi', '2022-09-28 18:15:02', 'Y', NULL),
	(3, 'hari', 1, 'atmi', '2022-09-29 10:37:29', 'Y', NULL),
	(4, 'mariofrans', 1, 'atmi', '2022-09-29 10:37:29', 'Y', NULL),
	(5, 'mariofrans_spv', 1, 'backdoor', '2023-01-06 15:13:25', 'Y', NULL);
...
-- Dumping data for table wms.t_running_number: 75 rows
...
CREATE TABLE IF NOT EXISTS `t_wh_activity` (
  ...
  KEY `process_id` (`process_id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=188 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table wms.t_wh_activity: 174 rows
...
-- Dumping data for table wms.t_wh_inbound_detail: 69 rows
...
-- Dumping data for table wms.t_wh_inbound_planning: 68 rows
...
INSERT INTO `t_wh_inbound_planning` (`inbound_planning_no`, `wh_id`, `client_project_id`, `supplier_id`, `status_id`, `reference_no`, `receipt_no`, `plan_delivery`, `order_id`, `task_type`, `remarks`, `data_upload1`, `data_upload2`, `data_upload3`, `is_active`, `is_deleted`, `user_created`, `datetime_created`, `user_updated`, `datetime_updated`) VALUES
	...
	('CBT-IN-0623-0002', 1, 1, 1, 'UIN', 'test_inbound', 'test_inbound', '2023-06-26 00:00:00', '1', 'Single Receive', NULL, '', '', '', 'Y', 'N', 'atmi', '2023-06-26 14:28:31', 'superadmin', '2024-07-15 14:13:41'),
	('CBT-IN-0623-0003', 1, 1, 1, 'UIN', 'test_2', 'test_2', '2023-06-26 00:00:00', '1', 'Single Receive', NULL, '', '', '', 'Y', 'N', 'atmi', '2023-06-26 14:49:30', 'superadmin', '2024-03-19 14:37:21'),
...
-- Dumping data for table wms.t_wh_inbound_planning_detail: 90 rows
...
-- Dumping data for table wms.t_wh_location_inventory: 86 rows
...
INSERT INTO `t_wh_location_inventory` (`location_id`, `location_type`, `client_project_id`, `pallet_id`, `sku`, `part_name`, `batch_no`, `serial_no`, `imei`, `part_no`, `color`, `size`, `expired_date`, `clasification_id`, `on_hand_qty`, `allocated_qty`, `picked_qty`, `available_qty`, `uom_name`, `stock_id`, `gr_id`, `gr_datetime`, `last_movement_id`, `user_created`, `datetime_created`, `user_updated`, `datetime_updated`, `is_active`) VALUES
	('test_location_1', 'Racking', 1, NULL, '112233446', 'Teh Kotak Lemon', '03022023', '', '', '', '', '', '2025-02-03', 1, 9, 17, 0, 4, 'PACK', 'AV', 'CBT-GR-0223-0002', '2023-02-03 10:21:46', 'CBT-08-0523-0001', 'atmi', '2023-02-03 10:29:14', 'atmi', '2023-05-04 12:34:58', 'Y'),
	('R1F3', 'Racking', 1, NULL, '32L5995', 'TV Toshiba 32L5995', 'test_26okt22_2', NULL, '', '', '', '', NULL, 1, -13, 7, 0, 10, 'PIECES', 'DMG', '', NULL, 'CBT-08-0123-0002', NULL, NULL, 'mariofrans_spv', '2023-05-24 15:46:35', 'Y'),
...
-- Dumping data for table wms.t_wh_movement: 41 rows
...
-- Dumping data for table wms.t_wh_movement_detail: 62 rows
...
INSERT INTO `t_wh_outbound_planning` (`outbound_planning_no`, `wh_id`, `client_project_id`, `supplier_id`, `order_id`, `status_id`, `reference_no`, `receipt_no`, `plan_delivery`, `notes`, `cancel_reason`, `user_created`, `datetime_created`, `user_updated`, `datetime_updated`) VALUES
	...
	('CBT-OUT-0423-0046', 1, 1, 1, '1', 'UNO', '123', '123', '2023-03-15', NULL, NULL, 'demo', '2023-04-25 15:31:26', NULL, NULL),
	...
	('CBT-OUT-0523-0007', 1, 1, 1, '1', 'UNO', 'test_25mei2023_1', 'test_25mei2023_1', '2023-05-25', NULL, NULL, 'mariofrans', '2023-05-25 18:24:34', NULL, NULL),
...
-- Dumping data for table wms.t_wh_picking: 47 rows
...
-- Dumping data for table wms.t_wh_receive: 45 rows
...
-- Dumping data for table wms.t_wh_receive_detail: 35 rows
...
INSERT INTO `t_wh_receive_return` (`gr_return_id`, `return_no`, `status_id`, `user_created`, `datetime_created`, `user_updated`, `datetime_updated`, `is_active`) VALUES
	...
	('CBT-GRR-0623-0009', 'CBT-RTN-0623-0009', 'ORR', 'mariofrans', '2023-06-13 09:26:00', NULL, NULL, 'Y');
...
INSERT INTO `t_wh_return` (`return_no`, `client_project_id`, `outbound_reference_no`, `awb`, `reference_no`, `return_date`, `return_from`, `status_id`, `reason`, `user_created`, `datetime_created`, `user_updated`, `datetime_updated`) VALUES
	...
	('CBT-RTN-0623-0009', 1, 'test_outbound_2501_2', '999712531548', 'test_outbound_2501_2', '2023-06-13', 'Toko Cahaya Abadi', 'RER', NULL, 'mariofrans', '2023-06-13 09:23:04', 'mariofrans', '2023-06-13 09:26:00');
...
CREATE TABLE IF NOT EXISTS `t_wh_scan_qty` (
  ...
  KEY `uom_id` (`uom_name`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=209 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table wms.t_wh_scan_qty: 138 rows
...
-- Dumping data for table wms.t_wh_temporary_movement: 75 rows
...
-- Dumping data for table wms.t_wh_temporary_movement_copy: 65 rows
...
) ENGINE=MyISAM AUTO_INCREMENT=92 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC COMMENT='sub menu transportation and unloading on inbound planning';

-- Dumping data for table wms.t_wh_transportation: 77 rows
...
INSERT INTO `t_wh_user` (`username`, `user_level_id`, `fullname`, `password`, `wh_id`, `email`, `phone`, `send_email`, `created_by`, `created_on`, `last_login`, `use_hht`, `is_active`, `is_deleted`, `is_android`, `is_web`, `remember_token`) VALUES
	('mariofrans', 5, 'Mario Frans', '$2y$10$q94x6NvmvY6eAagaLBlaauPMrcb5o.0S.RUK497nE.mf6//xGL8Te', 1, NULL, NULL, 'N', 'backdoor', '2022-09-27 16:10:33', NULL, NULL, 'Y', NULL, 'N', 'Y', NULL),
	('superadmin', 5, 'Super Admin', '$2a$10$ILnXIj7eQK8lSFjUgXDsGuYOjCzCUACRW.tRbguR2cpy.AMmBcvka', 1, NULL, NULL, 'Y', 'mariofrans', '2023-03-20 10:51:54', NULL, NULL, 'Y', NULL, 'Y', 'Y', NULL);
